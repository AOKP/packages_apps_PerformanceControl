...
public interface Constants {
    ...
    public static final String MV_TABLE0_PATH = "/sys/devices/system/cpu/cpu0/cpufreq/UV_mV_table";
    public static final String MV_TABLE1_PATH = "/sys/devices/system/cpu/cpu1/cpufreq/UV_mV_table";
    public static final String MV_TABLE2_PATH = "/sys/devices/system/cpu/cpu2/cpufreq/UV_mV_table";
    public static final String MV_TABLE3_PATH = "/sys/devices/system/cpu/cpu3/cpufreq/UV_mV_table";
}
