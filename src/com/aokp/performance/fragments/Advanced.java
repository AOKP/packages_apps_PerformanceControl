...
public class Advanced extends PreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        boolean fChargeExists = new File(FASTCHARGE_PATH + FASTCHARGE_FILE).exists();
        if (!fChargeExists) { 
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (PREF_FASTCHARGE.equals(key)) {
            ...
            String title = res.getString(R.string.dirty_ratio_title);
            ...
            String title = res.getString(R.string.dirty_background_title);
            ...
            String title = res.getString(R.string.dirty_expire_title);
            ...
            String title = res.getString(R.string.dirty_writeback_title);
            ...
            String title = res.getString(R.string.min_free_title);
            int currentProgress = Integer.parseInt(Helpers.readOneLine(MIN_FREE_PATH));
            int max = 8192;
            openDialog(currentProgress, title, max, mMinFreeK,
                    MIN_FREE_PATH, PREF_MIN_FREE_KB);
            return true;
        } else if (preference == mOvercommit) {
            String title = res.getString(R.string.overcommit_title);
            ...
            String title = res.getString(R.string.swappiness_title);
            ...
            String title = res.getString(R.string.vfs_title);
    ...
    public void openDialog(int currentProgress, String title, final int max,
        ...
        OnSeekBarChangeListener seekBarChangeListener = new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekbar, int progress, boolean fromUser) {
                ...
                settingText.setText(Integer.toString(seekbarProgress));
            }
            @Override
